...
* To generate the library, which contains all engine code, run 'makelib' from main folder.
...
* Para generar el archivo 'LIB' que contiene todo el código del motor, ejecuta 'makelib' desde la carpeta raiz.
