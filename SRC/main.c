...
void Load_Menu(){
	...
	LT_Load_Sprite("GFX/rocket.bmp",28,32);
...
void Run_Menu(){
	...
	while(Scene == 1){
		...
		if (LT_Keys[LT_JUMP]) {Scene = 2;game = 16;}
		if (LT_Keys[LT_ESC]) {
			LT_unload_sprite(16);
			LT_ExitDOS();
		}
...
void Run_TopDown(){
	...
	LT_Set_AI_Sprite(17,0,13,7,4,0);
	LT_Set_AI_Sprite(18,0,20,17,4,0);
	LT_Set_AI_Sprite(19,0,54,4,4,0);
	LT_Set_AI_Sprite(20,0,36,25,4,0);
	
	LT_Set_AI_Sprite(21,0,33,18,0,4);
	LT_Set_AI_Sprite(22,0,39,9,0,4);
	LT_Set_AI_Sprite(23,0,70,16,0,4);
...
void Run_Platform(){
	...
	//They will be drawn only if they are inside viewport.
	LT_Reset_AI_Stack();
	LT_Set_AI_Sprite(17,1,17,20,2,0);
	LT_Set_AI_Sprite(18,1,61,19,2,0);
	LT_Set_AI_Sprite(19,1,61,13,2,0);
	LT_Set_AI_Sprite(20,1,92,15,2,0);
	LT_Set_AI_Sprite(21,1,117,18,2,0);
	LT_Set_AI_Sprite(22,1,163,20,2,0);
	LT_Set_AI_Sprite(23,1,192,12,2,0);
	...
	while(Scene == 2){
		...
		switch (LT_Player_Col.tile_number){
			case 234: LT_Get_Item(16, 39, 0); diamonds++; break;
			case 235: LT_Get_Item(16, 26, 0); diamonds++; break;
			case 236: LT_Get_Item(16, 13, 0); diamonds++; break;
			case 237: LT_Get_Item(16, 0, 0); diamonds++; break;
			case 238: LT_Get_Item(16, 52, 0); diamonds++; break;
			case 239: LT_Get_Item(16, 77, 0); diamonds++; break;
			case 240: LT_Get_Item(16, 173, 0); diamonds++; break;
		} 
		...
		LT_Print_Window_Variable(32,diamonds);
